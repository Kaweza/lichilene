        ...
        <div class="container-xxl py-5">
          <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
              ...
              <p>
                At <strong>Tumaini english medium academy school</strong>, we provide a nurturing and stimulating environment with modern facilities to support your child's holistic development. Our goal is to offer the <strong>best early education</strong> with innovative teaching methods.
              </p>
            </div>
