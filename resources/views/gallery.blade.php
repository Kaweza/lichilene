        ...
        <div class="container-xxl py-5">
          <div class="container">
              ...
              <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                  <h1 class="mb-3">School Event Gallery</h1>
                  <p>Take a look at our exciting and fun school events in our gallery.</p>
              </div>
              ...
              <div class="row g-4">
                  ...
                  <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                      <div class="gallery-item position-relative overflow-hidden rounded">
                          <img src="archive/event 1.jpg" class="img-fluid w-100" alt="Abacus Competition"
                              style="height: 250px; object-fit: cover;">
                          <div class="p-3 text-center bg-white">
                              <h5 class="mb-0">Abacus Competition</h5>
                          </div>
                      </div>
                  </div>
                  ...
                  <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
                      <div class="gallery-item position-relative overflow-hidden rounded">
                          <img src="archive/event 2.jpg" class="img-fluid w-100" alt="Medical Camp"
                              style="height: 250px; object-fit: cover;">
                          <div class="p-3 text-center bg-white">
                              <h5 class="mb-0">Medical Camp</h5>
                          </div>
                      </div>
                  </div>
                  ...
                  <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                      <div class="gallery-item position-relative overflow-hidden rounded">
                          <img src="archive/event 3.jpg" class="img-fluid w-100" alt="Art & Craft"
                              style="height: 250px; object-fit: cover;">
                          <div class="p-3 text-center bg-white">
                  ...
                  <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.4s">
                      <div class="gallery-item position-relative overflow-hidden rounded">
                          <img src="archive/event 4.jpg" class="img-fluid w-100" alt="Art & Craft"
                              style="height: 250px; object-fit: cover;">
                          <div class="p-3 text-center bg-white">
                              <h5 class="mb-0">Art & Craft</h5>
                          </div>
                  ...
                  <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                      <div class="gallery-item position-relative overflow-hidden rounded">
                          <img src="archive/event 5.jpg" class="img-fluid w-100" alt="Cultural Event"
                              style="height: 250px; object-fit: cover;">
                          <div class="p-3 text-center bg-white">
                              <h5 class="mb-0">Cultural Event</h5>
                          </div>
                      </div>
                  </div>
                  ...
                  <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.6s">
                      <div class="gallery-item position-relative overflow-hidden rounded">
                          <img src="archive/event 6.jpg" class="img-fluid w-100" alt="Cultural Event"
                              style="height: 250px; object-fit: cover;">
                          <div class="p-3 text-center bg-white">
                              <h5 class="mb-0">Cultural Event</h5>
                          </div>
